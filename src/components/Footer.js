                ...
                <div className="row">
                    ...
                    <div className="col-lg-auto col-xs-12">
                        <div className="row">
                            ...
                            <div className="col"><i className="fa fa-linkedin"></i></div>
                            <div className="col"><i className="fa fa-instagram"></i></div>
                            <div className="col"><i className="fa fa-youtube"></i></div>
                        </div>
                    </div>
                </div>
            </div>
